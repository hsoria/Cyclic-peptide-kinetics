...
def ode_model(z, t, k0, k1, k2, k3, k4, k6, k7, k8, k9, k10, k12, k13):
    ...
    dAcdt = - k1*Ac*F + k3*((k1*Ac*F) / (k2+k3)) + k4*An - k6*An*Ac  + 2*k12*E2
    dAndt = + k2*((k1*Ac*F) / (k2+k3)) - k4*An  - k6*An*Ac 
...
def ode_solver(t, initial_conditions, params):
    ...
    k0, k1, k2, k3, k4,  k6, k7, k8, k9, k10, k12, k13 = (
        params['k0'],
        params['k1'],
        params['k2'],
        params['k3'],
    ...
    res = odeint(ode_model, initial_conditions, t, args=(k0, k1, k2, k3, k4, k6, k7, k8, k9, k10, k12, k13))
...
def error(params, initial_conditions, t, data):
    ...
    sol_subset = sol[:, [0, 2, 5, 6]]  # Extract columns corresponding to F, Ac, E2, E3
    error = data[:, [0, 1, 3, 4]] - sol_subset
    return error.ravel()

def error2(params, initial_conditions, t, data):
    sol = ode_solver(t, initial_conditions, params)
    sol_subset = sol[:, [0, 2, 5, 6]]  # Extract columns corresponding to F, Ac, E2, E3
    error = data[:, [0, 1, 3, 4]] - sol_subset
    return (error**2).sum()
